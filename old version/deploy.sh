...
echo "   git remote add origin https://github.com/YOUR_USERNAME/sriumadevitours.github.io.git"
echo "   git branch -M main"
echo "   git push -u origin main"
echo ""
echo "3. Enable GitHub Pages in Settings → Pages → main branch"
echo "4. Your site will be live at: https://sriumadevitours.github.io/"
echo "5. Custom domain: https://sriumadevitours.com"
echo ""
